                    ...
                    <ul class="menu-inner py-1">
                        ...
                        <li class="menu-item">
                            <router-link to="/" class="menu-link">
                                ...
                                <div data-i18n="Dashboards">ສະຕອກສິນຄ້າ</div>
                            </router-link>
                        </li>
                        <li class="menu-item">
                            <router-link to="/pos" class="menu-link">
                                <i
                                    class="menu-icon tf-icons bx bx-cart-alt"
                                ></i>
                        ...
                        <li class="menu-item">
                            <router-link to="/transection" class="menu-link">
                                <i
                                    class="menu-icon tf-icons bx bx-bar-chart-alt"
                                ></i>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            class="fi fi-us fis rounded-circle fs-3 me-1"
                                        ></i>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            ...
                                            >
                                                <i
                                                    class="fi fi-us fis rounded-circle fs-4 me-1"
                                                ></i>
                                        ...
                                        <li>
                                            ...
                                            >
                                                <i
                                                    class="fi fi-fr fis rounded-circle fs-4 me-1"
                                                ></i>
                                                <span class="align-middle"
                                                    >France</span
                                                >
                                        ...
                                        <li>
                                            ...
                                            >
                                                <i
                                                    class="fi fi-de fis rounded-circle fs-4 me-1"
                                                ></i>
                                                <span class="align-middle"
                                                    >German</span
                                                >
                                        ...
                                        <li>
                                            ...
                                            >
                                                <i
                                                    class="fi fi-pt fis rounded-circle fs-4 me-1"
                                                ></i>
                                                <span class="align-middle"
                                                    >Portuguese</span
                                                >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <i
                                                            class="bx bx-pie-chart-alt-2 fs-4"
                                                        ></i>
                                                    </span>
                                                    <a
                                                        href="index.html"
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <a
                                                    ...
                                                    ><i
                                                        class="bx fs-4 bx-envelope-open"
                                                    ></i
                                                ></a>
                                            </div>
                                        </li>
